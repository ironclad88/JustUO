...
{
    public class WeaponTestChest : LockableContainer
    {
        ...
        [Constructable]
        public WeaponTestChest(int level)
            : this(null, level, false)
        {
        }

        public WeaponTestChest(Mobile owner, int level, bool temporary)
            : base(0xE40)
        {
            this.m_Owner = owner;
            this.m_Level = level;
        ...
        public WeaponTestChest(Serial serial)
            : base(serial)
        {
        }
        ...
        private class RemoveGump : Gump
        {
            ...
            private readonly WeaponTestChest m_Chest;
            public RemoveGump(Mobile from, WeaponTestChest chest)
                : base(15, 15)
            {
                this.m_From = from;
                this.m_Chest = chest;
        ...
        private class RemoveEntry : ContextMenuEntry
        {
            private readonly Mobile m_From;
            private readonly WeaponTestChest m_Chest;
            public RemoveEntry(Mobile from, WeaponTestChest chest)
                : base(6149, 3)
            {
                this.m_From = from;
                this.m_Chest = chest;
