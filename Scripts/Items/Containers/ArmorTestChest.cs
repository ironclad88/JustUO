...
{
    public class ArmorTestChest : LockableContainer
    {
        ...
        [Constructable]
        public ArmorTestChest(int level)
            : this(null, level, false)
        {
        }

        public ArmorTestChest(Mobile owner, int level, bool temporary)
            : base(0xE40)
        {
            this.m_Owner = owner;
            this.m_Level = level;
        ...
        public ArmorTestChest(Serial serial)
            : base(serial)
        {
        }
        ...
        private class RemoveGump : Gump
        {
            ...
            private readonly ArmorTestChest m_Chest;
            public RemoveGump(Mobile from, ArmorTestChest chest)
                : base(15, 15)
            {
                this.m_From = from;
                this.m_Chest = chest;
        ...
        private class RemoveEntry : ContextMenuEntry
        {
            private readonly Mobile m_From;
            private readonly ArmorTestChest m_Chest;
            public RemoveEntry(Mobile from, ArmorTestChest chest)
                : base(6149, 3)
            {
                this.m_From = from;
                this.m_Chest = chest;
