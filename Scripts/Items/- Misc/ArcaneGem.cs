                ...
                else if (from.Skills[SkillName.Tailoring].Value >= 80.0)
                {
                    ...
                    if (isExceptional)
                    {
                        ...
                        else if (item is BaseArmor)
                        {
                            ...
                            ((BaseArmor)item).PhysicalBonus = ((BaseArmor)item).FireBonus = ((BaseArmor)item).ColdBonus = ((BaseArmor)item).PoisonBonus = ((BaseArmor)item).EnergyBonus = ((BaseArmor)item).EarthBonus = ((BaseArmor)item).NecroBonus = ((BaseArmor)item).HolyBonus = 0; // Is there a method to remove bonuses?
                        }
                        else if (item is BaseWeapon) // Sanity, weapons cannot recieve gems...
                        {
