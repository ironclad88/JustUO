...
namespace Server.Engines.Craft
{
    ...
    public class DefCarpentry : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            {
                index = AddCraft(typeof(Log), 1044294, 1027127, 0.0, 0.0, typeof(Log), 1044466, 1, 1044465);
           ...
           /* if (Core.AOS)	//Duplicate Entries to preserve ordering depending on era
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(GargishBanner), 1044294, 1095312, 94.7, 115.0, typeof(Log), 1044041, 50, 1044351);
            ...
            */
            ...
            /*if (Core.SA)
            {
                index = AddCraft(typeof(GargishCouchEastDeed), 1044291, 1111776, 90.0, 115.0, typeof(Log), 1044041, 75, 1044351);           
                SetNeededExpansion(index, Expansion.SA);
 
                index = AddCraft(typeof(GargishCouchSouthDeed), 1044291, 1111775, 90.0, 115.0, typeof(Log), 1044041, 75, 1044351);
                SetNeededExpansion(index, Expansion.SA);
 
                index = AddCraft(typeof(TerMurDresserEastDeed), 1044291, 1111784, 90.0, 115.0, typeof(Log), 1044041, 60, 1044351);
                SetNeededExpansion(index, Expansion.SA);
 
                index = AddCraft(typeof(TerMurDresserSouthDeed), 1044291, 1111783, 90.0, 115.0, typeof(Log), 1044041, 60, 1044351);
                SetNeededExpansion(index, Expansion.SA);
            }*/           
            #endregion
            ...
            AddCraft(typeof(WoodenKiteShield), 1044295, 1027032, -15.2, 34.8, typeof(Log), 1044036, 8, 1044037); //JustZH: moved from bs
            ...
            */
            ...
            /*if (Core.SA)
            {
                index = AddCraft(typeof(SerpentStoneStaff), 1044566, 1095367, 63.8, 113.8, typeof(Log), 1044041, 16,
                1044351);
                AddRes(index, typeof(EcruCitrine), 1026252, 1, 1053098);
                index = AddCraft(typeof(GargishGnarledStaff), 1044566, 1097488, 78.9, 103.9, typeof(Log), 1044041, 7,
                1044351);
            }
            */
            #endregion

            AddCraft(typeof(Club), 1044566, 1025043, 65, 115.0, typeof(Log), 1044041, 10, 1044351);
            AddCraft(typeof(BlackStaff), 1044566, 1023568, 81.5, 106.5, typeof(Log), 1044041, 9, 1044351);
