...
namespace Server.Gumps.RaceGumps
{
    ...
    public class GoblinGump : Gump
    {
        ...
        public GoblinGump(Mobile owner)
            : this(owner, owner, ResurrectMessage.Generic, false)
        {
        }


        public GoblinGump(Mobile owner, Mobile healer, ResurrectMessage msg, bool fromSacrifice)
            : this(owner, healer, msg, fromSacrifice, 0.0)
        {
        }

        public GoblinGump(Mobile owner, Mobile healer, ResurrectMessage msg, bool fromSacrifice, double hitsScalar)
            : base(100, 0)
        {
       ...
       //     this.AddHtml(0, 20, 400, 35, "Elf race", false, false);

            this.AddHtml(50, 55, 300, 140, "Enter the world with the Goblin race?", true, true);
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            from.CloseGump(typeof(GoblinGump));
            from.Frozen = false;
