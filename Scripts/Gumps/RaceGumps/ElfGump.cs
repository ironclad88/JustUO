...
namespace Server.Gumps.RaceGumps
{
    ...
    public class ElfGump : Gump
    {
        ...
        public ElfGump(Mobile owner)
            : this(owner, owner, ResurrectMessage.Generic, false)
        {
        }


        public ElfGump(Mobile owner, Mobile healer, ResurrectMessage msg, bool fromSacrifice)
            : this(owner, healer, msg, fromSacrifice, 0.0)
        {
        }

        public ElfGump(Mobile owner, Mobile healer, ResurrectMessage msg, bool fromSacrifice, double hitsScalar)
            : base(100, 0)
        {
...
//            this.AddHtml(0, 20, 400, 35, "Elf race", false, false);
            ...
            this.AddHtml(50, 55, 300, 140, "Enter the world with the Elf race?", true, true);
