...
namespace Server.Gumps.RaceGumps
{
    ...
    public class DarkElfGump : Gump
    {
        ...
        public DarkElfGump(Mobile owner)
            : this(owner, owner, ResurrectMessage.Generic, false)
        {
        }


        public DarkElfGump(Mobile owner, Mobile healer, ResurrectMessage msg, bool fromSacrifice)
            : this(owner, healer, msg, fromSacrifice, 0.0)
        {
        }

        public DarkElfGump(Mobile owner, Mobile healer, ResurrectMessage msg, bool fromSacrifice, double hitsScalar)
            : base(100, 0)
        {
         ...
         //   this.AddHtml(0, 20, 400, 35, "Dark-Elf race", false, false);
            ...
            this.AddHtml(50, 55, 300, 140, "Enter the world with the Dark-Elf race?", true, true);
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            from.CloseGump(typeof(DarkElfGump));
            from.Frozen = false;
