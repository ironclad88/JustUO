...
{
    public class EventStuddedGorget : StuddedGorget
    {
        ...
        [Constructable]
        public EventStuddedGorget(int hue)
        {

            Hue = hue;
            Name = "an Event Studded Leather Gorget";
        ...
        public EventStuddedGorget(Serial serial)
            : base(serial)
        {
        }
