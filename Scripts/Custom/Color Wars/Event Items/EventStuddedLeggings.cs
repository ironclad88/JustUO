...
{
    public class EventStuddedLeggings : StuddedLegs
    {
        ...
        [Constructable]
        public EventStuddedLeggings(int hue)
        {

            Hue = hue;
            Name = "Event Studded Leather Leggings";
        ...
        public EventStuddedLeggings(Serial serial)
            : base(serial)
        {
        }
