...
namespace Felladrin.Commands
{
    public static class History
    {
        ...
        public static void Initialize()
        {
            ...
            {
                CommandSystem.Register("Log", AccessLevel.Player, new CommandEventHandler(OnCommand));
        ...
        {
            public virtual string Title { get { return "Log - Auto Refresh: OFF"; } }
        ...
        {
            public override string Title { get { return "Log - Auto Refresh: ON"; } }
