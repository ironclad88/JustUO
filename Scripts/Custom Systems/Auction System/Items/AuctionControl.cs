...
namespace Arya.Auction
{
    ...
    public class AuctionControl : Item
    {
        ...
        /// </summary>
        private List<AuctionItem> m_Auctions;

        /// <summary>
        ///     This lists all auctions whose reserve hasn't been met
        /// </summary>
        private List<AuctionItem> m_Pending;
        ...
        /// </summary>
        public List<AuctionItem> Pending
        {
            ...
            : base(4484)
        {
            ...
            Visible = false;
            Movable = false;
            m_Auctions = new List<AuctionItem>();
            m_Pending = new List<AuctionItem>();
        ...
        public override void OnDelete()
        {
            ...
            if (!m_Delete)
            {
                ...
                newStone.m_Auctions.AddRange(m_Auctions);
