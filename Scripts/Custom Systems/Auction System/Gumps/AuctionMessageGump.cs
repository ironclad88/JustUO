...
namespace Arya.Auction
{
    ...
    public class AuctionMessageGump : Gump
    {
        ...
        {
            get { return AuctionSystem.Find(m_ID); }
            set { m_ID = value.ID; }
        }
        ...
        private void MakeGump()
        {
            ...
            if (auction != null)
            {
                AddLabel(125, 85, RedHue, auction.ItemName);

                AddButton(65, 112, 9762, 9763, 0, GumpButtonType.Reply, 0);
                m_Buttons.Add(0);
                AddLabel(85, 110, LabelHue, AuctionSystem.ST[27]);
            }
            else
            {
                AddLabel(125, 85, RedHue, AuctionSystem.ST[28]);
            }

            AddHtml(75, 170, 413, 120, m_HtmlMessage, true, false);
            AddLabel(75, 150, LabelHue, AuctionSystem.ST[29]);
            ...
            if (m_InformationMode)
            {
                ...
                m_Buttons.Add(1);
                AddLabel(125, 355, LabelHue, m_OkText);
            }
            else
            {
                AddButton(45, 300, 1147, 1149, 1, GumpButtonType.Reply, 0);
                m_Buttons.Add(1);
                AddLabel(125, 310, LabelHue, m_OkText);
                AddButton(45, 345, 1144, 1146, 2, GumpButtonType.Reply, 0);
                m_Buttons.Add(2);
                AddLabel(125, 355, LabelHue, m_CancelText);
            }
            ...
            if (m_ShowExpiration && auction != null)
            {
                AddLabel(
                    55, 405, RedHue,
                    String.Format(AuctionSystem.ST[30], auction.PendingTimeLeft.Days, auction.PendingTimeLeft.Hours));
            }
        }
