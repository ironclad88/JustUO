...
namespace Arya.Auction
{
    ...
    public class AuctionCommands
    {
        ...
        {
            CommandSystem.Register("InitAuction", AccessLevel.Administrator, OnInitAuction);
            CommandSystem.Register("MyAuction", AccessLevel.Player, OnMyAuction);
            CommandSystem.Register("Auction", AccessLevel.GameMaster, OnAuction);
            CommandSystem.Register("AuctionAdmin", AccessLevel.Administrator, OnAuctionAdmin);
        }
