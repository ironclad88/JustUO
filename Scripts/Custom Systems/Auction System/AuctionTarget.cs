...
namespace Arya.Auction
{
    ...
    public class AuctionTarget : Target
    {
        ...
        public AuctionTarget(AuctionTargetCallback callback, int range, bool allowground)
            : base(range, allowground, TargetFlags.None)
        {
            m_Callback = callback;
        }
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            try
            {
                m_Callback.DynamicInvoke(new[] {from, targeted});
            }
            catch
            {
                Console.WriteLine(
