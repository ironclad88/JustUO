...
{
    [CorpseName("an mist ostard corpse")]
    public class MistOstard : BaseMount
    {
        [Constructable]
        public MistOstard()
            : this("a mist ostard")
        ...
        public MistOstard(Serial serial)
            : base(serial)
        {
        }
