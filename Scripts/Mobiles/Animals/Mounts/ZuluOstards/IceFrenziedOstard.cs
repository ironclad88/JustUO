...
{
    [CorpseName("an ice frenzied ostard corpse")]
    public class IceFrenziedOstard : BaseMount
    {
        [Constructable]
        public IceFrenziedOstard()
            : this("a ice frenzied ostard")
        {
        }

        [Constructable]
        public IceFrenziedOstard(string name)
            : base(name, 0xDA, 0x3EA5, AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1152;
            this.stableName = "a ice frenzied ostard";
        ...
        public IceFrenziedOstard(Serial serial)
            : base(serial)
        {
        }
