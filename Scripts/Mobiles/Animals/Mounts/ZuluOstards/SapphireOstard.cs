...
{
    [CorpseName("an sapphire ostard corpse")]
    public class SapphireOstard : BaseMount
    {
        [Constructable]
        public SapphireOstard()
            : this("a sapphire ostard")
        {
        }

        [Constructable]
        public SapphireOstard(string name)
            : base(name, 0xDB, 0x3EA5, AIType.AI_Animal, FightMode.None, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1170;
            this.stableName = "a sapphire ostard";
        ...
        public SapphireOstard(Serial serial)
            : base(serial)
        {
        }
