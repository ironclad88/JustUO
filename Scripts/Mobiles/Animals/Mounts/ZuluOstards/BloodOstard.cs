...
{
    [CorpseName("an blood ostard corpse")]
    public class BloodOstard : BaseMount
    {
        [Constructable]
        public BloodOstard()
            : this("a blood ostard")
        ...
        public BloodOstard(Serial serial)
            : base(serial)
        {
        }
