...
{
    [CorpseName("an mountain ostard corpse")]
    public class MountainOstard : BaseMount
    {
        [Constructable]
        public MountainOstard()
            : this("a mountain ostard")
        {
        }

        [Constructable]
        public MountainOstard(string name)
            : base(name, 0xDB, 0x3EA5, AIType.AI_Animal, FightMode.None, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1160;
            this.stableName = "a mountain ostard";
            ...
            this.Tamable = true;
            this.ControlSlots = 1;
            this.MinTameSkill = 75;
        }

        public MountainOstard(Serial serial)
            : base(serial)
        {
        }
