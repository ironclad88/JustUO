...
{
    [CorpseName("an earth ostard corpse")]
    public class EarthOstard : BaseMount
    {
        [Constructable]
        public EarthOstard()
            : this("a earth ostard")
        ...
        public EarthOstard(Serial serial)
            : base(serial)
        {
        }
