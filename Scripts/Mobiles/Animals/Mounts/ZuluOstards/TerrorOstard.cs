...
{
    [CorpseName("an terror ostard corpse")]
    public class TerrorOstard : BaseMount
    {
        [Constructable]
        public TerrorOstard()
            : this("a terror ostard")
        {
        }

        [Constructable]
        public TerrorOstard(string name)
            : base(name, 0xDB, 0x3EA5, AIType.AI_Animal, FightMode.None, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1280;
            this.stableName = "a terror ostard";
        ...
        public TerrorOstard(Serial serial)
            : base(serial)
        {
        }
