...
{
    [CorpseName("an golden ostard corpse")]
    public class GoldenOstard : BaseMount
    {
        [Constructable]
        public GoldenOstard()
            : this("a golden ostard")
        {
        }

        [Constructable]
        public GoldenOstard(string name)
            : base(name, 0xDB, 0x3EA5, AIType.AI_Animal, FightMode.None, 10, 1, 0.2, 0.4)
        {
            this.Hue = 48;
            this.stableName = "a golden ostard";
        ...
        public GoldenOstard(Serial serial)
            : base(serial)
        {
        }
