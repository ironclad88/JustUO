...
{
    [CorpseName("an swamp frenzied ostard corpse")]
    public class SwampFrenziedOstard : BaseMount
    {
        [Constructable]
        public SwampFrenziedOstard()
            : this("a swamp frenzied ostard")
        {
        }

        [Constructable]
        public SwampFrenziedOstard(string name)
            : base(name, 0xDA, 0x3EA5, AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Hue = 2001;
            this.stableName = "a swamp frenzied ostard";
        ...
        public SwampFrenziedOstard(Serial serial)
            : base(serial)
        {
        }
