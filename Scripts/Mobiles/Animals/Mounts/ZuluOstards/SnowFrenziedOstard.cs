...
{
    [CorpseName("an snow frenzied ostard corpse")]
    public class SnowFrenziedOstard : BaseMount
    {
        [Constructable]
        public SnowFrenziedOstard()
            : this("a snow frenzied ostard")
        {
        }

        [Constructable]
        public SnowFrenziedOstard(string name)
            : base(name, 0xDA, 0x3EA5, AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1156;
            this.stableName = "a snow frenzied ostard";
