...
{
    [CorpseName("an amethyst frenzied ostard corpse")]
    public class AmethystFrenziedOstard : BaseMount
    {
        [Constructable]
        public AmethystFrenziedOstard()
            : this("a amethyst frenzied ostard")
        {
        }

        [Constructable]
        public AmethystFrenziedOstard(string name)
            : base(name, 0xDA, 0x3EA5, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1174;
            this.stableName = "a amethyst frenzied ostardd";
        ...
        public AmethystFrenziedOstard(Serial serial)
            : base(serial)
        {
        }
