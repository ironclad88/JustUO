...
{
    [CorpseName("an plains frenzied ostard corpse")]
    public class PlainsFrenziedOstard : BaseMount
    {
        [Constructable]
        public PlainsFrenziedOstard()
            : this("a plains frenzied ostard")
        {
        }

        [Constructable]
        public PlainsFrenziedOstard(string name)
            : base(name, 0xDA, 0x3EA5, AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Hue = 53;
            this.stableName = "a plains frenzied ostard";
        ...
        public PlainsFrenziedOstard(Serial serial)
            : base(serial)
        {
        }
