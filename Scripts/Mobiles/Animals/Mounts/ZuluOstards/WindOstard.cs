...
{
    [CorpseName("an wind ostard corpse")]
    public class WindOstard : BaseMount
    {
        [Constructable]
        public WindOstard()
            : this("a wind ostard")
        ...
        public WindOstard(Serial serial)
            : base(serial)
        {
        }
