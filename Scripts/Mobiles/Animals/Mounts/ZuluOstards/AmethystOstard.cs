...
{
    [CorpseName("an amethyst ostard corpse")]
    public class AmethystOstard : BaseMount
    {
        [Constructable]
        public AmethystOstard()
            : this("a amethyst ostard")
        {
        }

        [Constructable]
        public AmethystOstard(string name)
            : base(name, 0xDB, 0x3EA5, AIType.AI_Animal, FightMode.None, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1174;
            this.stableName = "a amethyst ostard";
        ...
        public AmethystOstard(Serial serial)
            : base(serial)
        {
        }
