...
{
    [CorpseName("an mist frenzied ostard corpse")]
    public class MistFrenziedOstard : BaseMount
    {
        [Constructable]
        public MistFrenziedOstard()
            : this("a mist frenzied ostard")
        {
        }

        [Constructable]
        public MistFrenziedOstard(string name)
            : base(name, 0xDA, 0x3EA5, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Hue = 90;
            this.stableName = "a mist frenzied ostard";
        ...
        public MistFrenziedOstard(Serial serial)
            : base(serial)
        {
        }
