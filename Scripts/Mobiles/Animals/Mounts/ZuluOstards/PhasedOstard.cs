...
{
    [CorpseName("an phased ostard corpse")]
    public class PhasedOstard : BaseMount
    {
        [Constructable]
        public PhasedOstard()
            : this("a phased ostard")
        {
        }

        [Constructable]
        public PhasedOstard(string name)
            : base(name, 0xDB, 0x3EA5, AIType.AI_Animal, FightMode.None, 10, 1, 0.2, 0.4)
        {
            this.Hue = 16385;
            this.stableName = "a phased ostard";
        ...
        public PhasedOstard(Serial serial)
            : base(serial)
        {
        }
