...
{
    [CorpseName("an stone ostard corpse")]
    public class StoneOstard : BaseMount
    {
        [Constructable]
        public StoneOstard()
            : this("a stone ostard")
        ...
        public StoneOstard(Serial serial)
            : base(serial)
        {
        }
