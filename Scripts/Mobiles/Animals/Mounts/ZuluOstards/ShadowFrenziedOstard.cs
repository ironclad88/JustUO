...
{
    [CorpseName("an shadow frenzied ostard corpse")]
    public class ShadowFrenziedOstard : BaseMount
    {
        [Constructable]
        public ShadowFrenziedOstard()
            : this("a shadow frenzied ostard")
        {
        }

        [Constructable]
        public ShadowFrenziedOstard(string name)
            : base(name, 0xDA, 0x3EA5, AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Hue = 1904;
            this.stableName = "a shadow frenzied ostard";
