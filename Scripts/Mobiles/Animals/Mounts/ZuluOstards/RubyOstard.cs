...
{
    [CorpseName("an ruby ostard corpse")]
    public class RubyOstard : BaseMount
    {
        [Constructable]
        public RubyOstard()
            : this("a ruby ostard")
        ...
        public RubyOstard(Serial serial)
            : base(serial)
        {
        }
