...
{
    [CorpseName("an fire ostard corpse")]
    public class FireOstard : BaseMount
    {
        [Constructable]
        public FireOstard()
            : this("a fire ostard")
        ...
        public FireOstard(Serial serial)
            : base(serial)
        {
        }
