...
{
    public class HermitAI : BaseAI
    {
        public HermitAI(BaseCreature m)
            : base(m)
        {
        }
        ...
        public override bool DoActionWander()
        {
            ...
            if (this.AcquireFocusMob(this.m_Mobile.RangePerception, this.m_Mobile.FightMode, false, false, true))
            {
                ...
                this.m_Mobile.Say(true, "My pantaloons are full of weasels. Inform the Queen, so that she might shoo them away. Here we go 'round the mulberry bush. Go monkey GO!");
