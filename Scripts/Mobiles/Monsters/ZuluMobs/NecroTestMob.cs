...
{
    [CorpseName("an crappy corpse")]
    public class NecroTestMob : BaseCreature
    {
        [Constructable]
        public NecroTestMob()
            : base(AIType.AI_NecroTest, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            this.Name = "an necro test mob";
            this.Body = 0x0e;
            ...
            this.SetSkill(SkillName.Necromancy, 200, 210);
            this.SetSkill(SkillName.SpiritSpeak, 200, 210);
        ...
        public NecroTestMob(Serial serial)
            : base(serial)
        {
        }
