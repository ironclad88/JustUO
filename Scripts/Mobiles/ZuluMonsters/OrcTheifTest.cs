...
namespace Server.Mobiles.ZuluMonsters
{
    ...
    public class OrcTheifTest : BaseCreature
    {
        [Constructable]
        public OrcTheifTest()
            : base(AIType.AI_OrcScout, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            this.Name = NameList.RandomName("orc") + " the Theif";
            this.Body = 17;
        ...
        public OrcTheifTest(Serial serial)
            : base(serial)
        {
        }
