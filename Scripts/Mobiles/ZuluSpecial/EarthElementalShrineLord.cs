...
namespace Server.Mobiles.ZuluSpecial
{
    ...
    [CorpseName("a earth elemental lord corpse")]
    public class EarthElementalShrineLord : BaseCreature
    {
        [Constructable]
        public EarthElementalShrineLord()
            : base(AIType.AI_Elemental, FightMode.None, 0, 0, 0, 0)
        {
            this.Name = "the Earth Element Shrine Lord";
            this.Body = 0xE;
        ...
        public EarthElementalShrineLord(Serial serial)
            : base(serial)
        {
        }
