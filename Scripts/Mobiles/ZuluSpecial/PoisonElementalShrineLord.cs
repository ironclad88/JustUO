...
namespace Server.Mobiles.ZuluSpecial
{
    ...
    [CorpseName("a poison elemental lord corpse")]
    public class PoisonElementalShrineLord : BaseCreature
    {
        [Constructable]
        public PoisonElementalShrineLord()
            : base(AIType.AI_Elemental, FightMode.None, 0, 0, 0, 0)
        {
            this.Name = "the Poison Element Shrine Lord";
            this.Body = 0x0d;
        ...
        public PoisonElementalShrineLord(Serial serial)
            : base(serial)
        {
        }
