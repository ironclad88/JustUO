...
namespace Server.Mobiles
{
	public class Aghor : BaseCreature
	{
        ...
        {
            AbilityCollection.AreaEffect(TimeSpan.FromSeconds(0.1), TimeSpan.FromSeconds(0.1), 0.1, Map, Location, 14000, 13, 1151, 4, 12, 3, true, false, false);
        ...
        public void DoBlizzard()
        {
            for (int i = 0; i < 100; ++i)
            {
                ...
                if (Map.CanFit(loc, 0, true))
                {
                    double delay = 15 * Utility.RandomDouble();
        ...
        public override Poison PoisonImmune { get { return Poison.DarkGlow; } }
