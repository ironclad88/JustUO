...
namespace Server.Mobiles.ZuluSpecial
{
    ...
    [CorpseName("a fire elemental lord corpse")]
    public class FireElementalShrineLord : BaseCreature
    {
        [Constructable]
        public FireElementalShrineLord()
            : base(AIType.AI_Elemental, FightMode.None, 0, 0, 0, 0)
        {
            this.Name = "the Fire Element Shrine Lord";
            this.Body = 0x0f;
        ...
        public FireElementalShrineLord(Serial serial)
            : base(serial)
        {
        }
