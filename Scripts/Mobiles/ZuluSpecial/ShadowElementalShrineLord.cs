...
namespace Server.Mobiles.ZuluSpecial
{
    ...
    [CorpseName("a shadow elemental lord corpse")]
    public class ShadowElementalShrineLord : BaseCreature
    {
        [Constructable]
        public ShadowElementalShrineLord()
            : base(AIType.AI_Elemental, FightMode.None, 0, 0, 0, 0)
        {
            this.Name = "the Shadow Element Shrine Lord";
            this.Body = 0x0f;
        ...
        public ShadowElementalShrineLord(Serial serial)
            : base(serial)
        {
        }
