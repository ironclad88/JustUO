...
{
    public class VolcanicEruiptionSpell : DruidSpell // höhö
    {
        ...
        public VolcanicEruiptionSpell(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        {
            private VolcanicEruiptionSpell m_Owner;

            public InternalTarget(VolcanicEruiptionSpell owner) : base(12, true, TargetFlags.None)
            {
                m_Owner = owner;
            }
