...
{
    public class AnimateDeadSpellZulu : NecroSpell
    {
        ...
        public AnimateDeadSpellZulu(Mobile caster, Item scroll)
        ...
        {
            private readonly AnimateDeadSpellZulu m_Owner;

            public InternalTarget(AnimateDeadSpellZulu owner)
